  ...
  return (
    <>
      ...
      <div className="lg:h-[calc(100vh-40px)]">
        ...
        <div className="p-2 pb-3 mx-auto w-full h-full bg-slate-600">
          <div className="flex lg:flex-row lg:h-4/6 lg:justify-around flex-col bg-slate-600 font-semibold">
          ...
          <div className="flex lg:flex-row lg:h-2/6 lg:justify-around flex-col bg-slate-600 rounded">
            <div className="lg:w-1/3 m-1 p-2 flex flex-col justify-left rounded bg-slate-200">
